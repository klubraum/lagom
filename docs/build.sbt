...
val AkkaVersion = sys.props.getOrElse("lagom.build.akka.version", "2.7.0") // sync with project/Dependencies.scala

val JUnitVersion          = "4.13.2"
val JUnitInterfaceVersion = "0.11"
val ScalaTestVersion      = "3.0.8"
val PlayVersion           = "2.8.18" // sync with project/Dependencies.scala
